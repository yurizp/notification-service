...
import br.com.yurizp.notificationservice.controller.request.notificationsettings.email.EmailRequest;
import br.com.yurizp.notificationservice.controller.request.notificationsettings.email.Sender;
import br.com.yurizp.notificationservice.controller.request.notificationsettings.email.Server;
...
public class EmailEntityMapper {
    ...
    private static List<EmailTemplateEntity> createEmailTemplates(EmailRequest emailRequest) {
        if (CollectionUtils.isEmpty(emailRequest.getEmailTemplates())) {
            return null;
        }
